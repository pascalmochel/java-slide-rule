...
public class GroupByTest {
	...
	public void testA() throws Exception {
		...
		try {
			...
			/**/Criteria.select(A.class, Aggregate.nul(A.id), Aggregate.max(A.name, "NAME"),
					Aggregate.field(A.city), Aggregate.max(A.age, "AGE"))
			/**/.groupBy(A.city)
			/**/.get();
			...
			/**/Criteria.select(A.class, Aggregate.nul(A.id), Aggregate.max(A.name, "NAME"),
					Aggregate.field(A.city), Aggregate.max(A.age, "AGE"))
			/**/.groupBy(A.city)
			/**/.having(Restriction.ne(A.city, "LNZ"))
			/**/.orderBy(Order.asc(A.age))
			/**/.get();
