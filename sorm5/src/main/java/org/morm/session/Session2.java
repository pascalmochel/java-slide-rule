...
//			.getLogger(Session2.class.getName());
//
...
//	 */
//	public Session2(final DataSource dataSource,
//			final Integer transactionIsolation) {
//		super();
...
//			} catch (final SQLException exc) {
//				throw new SormException(
//						"throwed exception attempting to obtain a fresh connection",
//						exc);
//			}
//		}
//		return connection;
...
//		if (connection == null) {
//			throw new SormException(
//					"business operation are ocurred outside of a transaction bounds");
...
//		} catch (final SQLException exc) {
//			throw new SormException(
//					"throwed exception during transaction commit", exc);
//		}
//		// } else {
...
//		} catch (final SQLException exc) {
//			throw new SormException(
//					"throwed exception during transaction rollback", exc);
//		}
//		// } else {
//		// String savePointName = null;
//		// try {
...
//		// } catch (final SQLException exc) {
//		// throw new
//		// SormException("throwed exception during transaction rollback. savePointName="
//		// + savePointName, exc);
//		// }
//		// }
//	}
...
//			throw new SormException(
//					"throwed exception reading status from a connection", e);
//		}
//	}
//
